...
import {
  BarChart3, Users, GitCompare, DollarSign, PieChart, Kanban, LayoutDashboard, LogOut, HelpCircle,
} from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { key: "/dashboard", label: "Dashboard", icon: LayoutDashboard, roles: ["admin", "sdr", "closer"] },
  ...
  return (
    <aside className="w-56 shrink-0 bg-sidebar-background border-r border-sidebar-border flex flex-col h-screen sticky top-0">
      ...
      <div className="p-4 border-b border-sidebar-border">
        <h1 className="text-base font-bold text-sidebar-foreground tracking-tight">Pena Quadros</h1>
